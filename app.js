...
function Store(name, min, max, age) {
  ...
  this.minCust      = min; //eslint-disable-line
  this.maxCust      = max; //eslint-disable-line
  this.avgCookies   = age; //eslint-disable-line
  this.totalCookies = 0; //eslint-disable-line
...
//adding the total to the end of the list
  td.textContent = 'Total: ' + this.totalCookies + 'Cookies';
};
...
// this creates a table header for times
...
for(var store = 0; store < time.length; store++){
